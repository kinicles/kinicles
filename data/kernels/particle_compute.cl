...
__kernel AUTO_VEC_HINT void particle_compute(const float time_passed, const float living_time,
											 const uint particle_count, const float4 gravity,
